...
__PACKAGE__->thingiverse_attributes(
    {
        ...
        fields =>  {
            ...
            files_url           => { isa => 'Str' },
            thumbnail           => { isa => 'Str' },
            is_wip              => { isa => 'Boolean', coerce => 1 },
            is_liked            => { isa => 'Boolean', coerce => 1 },
            is_private          => { isa => 'Boolean', coerce => 1 },
            in_library          => { isa => 'Boolean', coerce => 1 },
            is_featured         => { isa => 'Boolean', coerce => 1 },
            is_collected        => { isa => 'Boolean', coerce => 1 },
            is_purchased        => { isa => 'Boolean', coerce => 1 },
            is_published        => { isa => 'Boolean', coerce => 1 },
